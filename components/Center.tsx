...
function Center() {
    ...
    return <div className="flex-grow">
        <header className="absolute top-5 right-8">
            <div className="flex items-center bg-black space-x-3 opacity-90 transition-opacity hover:opacity-80 cursor-pointer rounded-full p-1 pr-2 text-white">
        ...
        <section className={`flex items-end space-x-7 bg-gradient-to-b to-black ${color} h-80 text-white padding-8`}>
            ...
            <div>
                <p>PLAYLIST</p>
                <h1 className="text-20xl md:text-3xl xl:text-5xl font-bold">{playlist?.name}</h1>
            </div>
        </section>
        <div>
            <Songs />
